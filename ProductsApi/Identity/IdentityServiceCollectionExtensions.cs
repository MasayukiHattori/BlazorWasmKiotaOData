...
namespace ProductsApi.Identity
{
    /// <summary>
    ...
    public static class IdentityServiceCollectionExtensions
    {
        ...
        /// <summary>
        /// The scheme used to identify combination of <see cref="IdentityConstants.BearerScheme"/> and <see cref="IdentityConstants.ApplicationScheme"/>.
        /// </summary>
        private const string BearerAndApplicationScheme = IdentityPrefix + ".BearerAndApplication";
        ...
        public static IdentityBuilder AddCustomIdentityApiEndpoints<TUser>(this IServiceCollection services)
            where TUser : class, new()
            => services.AddCustomIdentityApiEndpoints<TUser>(_ => { });
        ...
        /// <returns>The <see cref="IdentityBuilder"/>.</returns>
        public static IdentityBuilder AddCustomIdentityApiEndpoints<TUser>(
            this IServiceCollection services,
            ...
            where TUser : class, new()
        {
            ...
            services
                ...
                {
                    options.BearerTokenExpiration = new TimeSpan(2, 0, 0, 0);
                })
