...
using System;
namespace BlazorWasm.Client.Refresh
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::BlazorWasm.Client.Refresh.RefreshRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::BlazorWasm.Client.Models.AccessTokenResponse?> PostAsync(global::BlazorWasm.Client.Models.RefreshRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::BlazorWasm.Client.Models.AccessTokenResponse> PostAsync(global::BlazorWasm.Client.Models.RefreshRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::BlazorWasm.Client.Models.RefreshRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::BlazorWasm.Client.Models.RefreshRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::BlazorWasm.Client.Refresh.RefreshRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::BlazorWasm.Client.Refresh.RefreshRequestBuilder WithUrl(string rawUrl)
        {
            return new global::BlazorWasm.Client.Refresh.RefreshRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
